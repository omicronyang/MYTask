...
$task_type_order = sprintf("%s,", GetSQLValueString($_POST['task_status_order'], "text"));
}

if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tk_status (task_status, task_status_display, task_status_backup1, task_status_backup2) VALUES (%s, %s, $task_type_order %s)",
