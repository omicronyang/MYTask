...
inner join tk_task_type on tk_task.csa_type=tk_task_type.id 
WHERE task_type NOT LIKE '$multilingual_dd_status_ca' AND csa_root LIKE '$wbssum%'";
    ...
    <td  valign="top">
        ...
        <tr>
          <td ><ul class="breadcrumb">
			  ...
			  <li><?php if ($row_Recordset_task['csa_father'] <> -1) { ?>
            <?php echo $multilingual_default_task_parent; ?>: <a href="default_task_edit.php?editID=<?php echo $row_Recordset_pattask['tid']; ?>" >[<?php echo $row_Recordset_pattask['task_type']; ?>] <?php echo $row_Recordset_pattask['csa_text']; ?></a> 
            <?php } else {
	 echo $multilingual_subtask_root;
	  ...
	  <li class="float_right"><?php echo $multilingual_default_taskid; ?>: <?php echo $row_Recordset_task['tid']; ?></li>
        ...
        <tr>
          <td >
            <span class="breakwordsfloat_left"><h2>[<?php echo $row_Recordset_task['task_type']; ?>] <?php echo htmlentities($row_Recordset_task['csa_text'], ENT_COMPAT, 'utf-8'); ?></h2></span> </td>
        </tr>
              ...
              <tbody>
                <?php do { ?>
                  <tr>
                    ...
                    <td class="task_title"><div  class="text_overflow_150 task_title"  title="<?php echo $row_Recordset_subtask['csa_text']; ?>"> <a href="default_task_edit.php?editID=<?php echo $row_Recordset_subtask['tid']; ?>" > <b>[<?php echo $row_Recordset_subtask['task_type']; ?>]</b> <?php echo $row_Recordset_subtask['csa_text']; ?> </a> </div></td>
