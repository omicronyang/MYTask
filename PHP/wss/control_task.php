...
<div class="alert" style="margin-left:7px; margin-right:7px;">
  ...
  <h5><?php echo $multilingual_outofdate_title; ?></h5>
   ...
   [<?php echo $row_timeout['task_type']; ?>] <?php echo $row_timeout['csa_text']; ?> 
   </a>
            </td>
...
?>
		...
		><?php echo $row_Recordset_type['task_type']?></option>
        <?php
...
<table  border="0" cellspacing="0" cellpadding="0" align="center"  class="maintable tasktab_bl" >
 ...
 <?php do { ?>
      ...
      <td class="week_style_padtd" ><div  class="text_overflow_150  task_title"><a href="default_task_edit.php?editID=<?php echo $row_Recordset1['tid']; ?>&pagetab=<?php echo $pagetabs; ?>"  target="_parent">[<?php echo $row_Recordset1['task_type']; ?>] <?php echo $row_Recordset1['csa_text']; ?></a></div></td>
