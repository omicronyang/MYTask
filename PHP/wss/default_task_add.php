...
$wbs = $row_Recordset_task['csa_root'].">".$row_Recordset_task['tid'].">".$wbs_id; 
}
...
do {  
?>
                <option value="<?php echo $row_Recordset_type['id']?>"><?php echo $row_Recordset_type['task_type']?></option>
                <?php
