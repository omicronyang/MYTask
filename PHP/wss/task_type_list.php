...
if ( empty( $_POST['task_type_order'] ) ){
$task_type_order = "'0',";
}else{
$task_type_order = sprintf("%s,", GetSQLValueString($_POST['task_type_order'], "text"));
}

if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tk_task_type (task_type, task_type_backup, tk_task_typerank) VALUES (%s, $task_type_order '')",
                       GetSQLValueString($_POST['task_type'], "text"));
...
mysql_select_db($database_tankdb, $tankdb);
$query_Recordset1 = "SELECT * FROM tk_task_type ORDER BY task_type_backup ASC";
...
<!--
J.check.rules = [
	{name: 'task_type', mid: 'csa_text_msg', requir: true, type: '',  warn: '<?php echo $multilingual_default_required4; ?>'},
	{name: 'task_type_order', mid: 'task_type_order_msg', type: 'rang', min: -1, warn: '<?php echo $multilingual_default_required5; ?>' }
...
<tbody>
    <tr>
      <td><?php echo $multilingual_tasktype_name; ?>:<br />        
        <input type="text" name="task_type" id="task_type" value="" size="32"  class="width-p80"/><span id="csa_text_msg"></span></td>
		<td><?php echo $multilingual_default_order; ?>:<br />        
        <input type="text" name="task_type_order" id="task_type_order" value="" size="32" /><span id="task_type_order_msg"></td>
    </tr>
</tbody>
 <tfoot>
    <tr>
...
<?php do { ?>
    <tr>
      <td width="50%"><?php echo $row_Recordset1['task_type']; ?></td>
	  <td width="20%"><?php echo $row_Recordset1['task_type_backup']; ?></td>
