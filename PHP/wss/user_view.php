...
$query_Recordset_log = sprintf("SELECT * FROM tk_task_byday 
								...
								inner join tk_task_type on tk_task_byday.csa_tb_backup4=tk_task_type.id 
...
echo $logyear[0]; ?>-<?php echo $logmonth[0]; ?>-<?php echo $logmonth[1]; ?>	
	  ...
	  <?php echo $row_Recordset_log['task_type']; ?> - 
...
<thead >
        ...
        <?php do { ?>
          <tr>
            ...
            <td class="task_title"  title="<?php echo $row_Recordset_task['csa_text']; ?> "><div  class="text_overflow_150 task_title"><a href="default_task_edit.php?editID=<?php echo $row_Recordset_task['tid']; ?>" ><b>[<?php echo $row_Recordset_task['task_type']; ?>]</b> <?php echo $row_Recordset_task['csa_text']; ?></a></div></td>
