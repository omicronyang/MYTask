...
$query_Recordset_task = sprintf("SELECT *
							...
							inner join tk_status on tk_task.csa_status=tk_status.id 
								WHERE csa_project = %s AND csa_father = '-1' ORDER BY csa_last_update DESC", GetSQLValueString($colname_Recordset_task, "text"));
...
<thead >
        ...
        <?php do { ?>
          <tr>
			...
			<b>[<?php echo $row_Recordset_task['task_type']; ?>]</b> <?php echo $row_Recordset_task['csa_text']; ?>			</a>			</div></td>
