...
namespace MYTask {
    ...
    public partial class FormMain : Form {
        ...
        public FormMain() {
            ...
            PProjProfile.Location = new Point(48 , 32);
        ...
        private void UIColor_Update( int ColorType ) {
            ...
            PProjProfile.UpdateColor(Theme);
        ...
        */
        ...
        private void ShowPanelProjProfile() {
            FocusP = PProjProfile;
            UI_Title.Text = "WSS - 项目详情";
        }
        private void SelectPanel( int index ) {
            ...
            switch (index) {
                ...
                case 7: { ShowPanelProjProfile(); break; }
            }
        ...
        private void ChangePanelVision( int index ) {
            ...
            if (index == 7) PProjProfile.Show(); else PProjProfile.Hide();
        }
